...
var G__12567 = o;
(G__12567[reagent.impl.template.cached_prop_name(k)] = (reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__12568__delegate = function (args){
...
return G__12568__delegate.call(this,args);};
...
return G__12568__delegate(args);
});
...
var G__12575 = jsprops;
(G__12575["defaultValue"] = value);

(G__12575["onChange"] = ((function (G__12575,v,value,on_change){
return (function (p1__12573_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__12573_SHARP_);
});})(G__12575,v,value,on_change))
);
...
var vec__12580 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12580,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12580,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12580,(2),null);
...
var jsprops = {"argv": v};
var temp__4429__auto___12583 = reagent.impl.template.key_from_vec(v);
if((temp__4429__auto___12583 == null)){
} else {
var key_12584 = temp__4429__auto___12583;
(jsprops["key"] = key_12584);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__12586 = (new reagent.impl.template.NativeWrapper());
(G__12586["name"] = c);
...
var G__12588 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,comp,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__12588) : reagent.impl.template.as_element.call(null,G__12588));
} else {
...
var len__7513__auto___12594 = arguments.length;
var i__7514__auto___12595 = (0);
while(true){
if((i__7514__auto___12595 < len__7513__auto___12594)){
args__7520__auto__.push((arguments[i__7514__auto___12595]));

var G__12596 = (i__7514__auto___12595 + (1));
i__7514__auto___12595 = G__12596;
continue;
} else {
}
break;
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq12592){
var G__12593 = cljs.core.first(seq12592);
var seq12592__$1 = cljs.core.next(seq12592);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__12593,seq12592__$1);
});
...
break;
default:
var G__12600 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(v,(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null);
v = G__12600;
continue;
...
var n__7358__auto___12601 = a.length;
var i_12602 = (0);
while(true){
if((i_12602 < n__7358__auto___12601)){
(a[i_12602] = reagent.impl.template.as_element((a[i_12602])));

var G__12603 = (i_12602 + (1));
i_12602 = G__12603;
continue;
} else {
}
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__7358__auto___12604 = a.length;
var i_12605 = (0);
while(true){
if((i_12605 < n__7358__auto___12604)){
var val_12606 = (a[i_12605]);
if((cljs.core.vector_QMARK_(val_12606)) && ((reagent.impl.template.key_from_vec(val_12606) == null))){
(o["no-key"] = true);
} else {
}

(a[i_12605] = reagent.impl.template.as_element(val_12606));
...
var ctx = {};
var vec__12609 = reagent.ratom.check_derefs(((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
});})(ctx))
);
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12609,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12609,(1),null);
...
var G__12611 = (cljs.core.count(argv) - first_child);
switch (G__12611) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv(((function (G__12611){
